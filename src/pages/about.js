      ...
      <StyledAbout>
        <span style={{ marginTop: '5rem' }}>
          <Title style={{ paddingBottom: '4rem' }}>
            Blockchain 3.0 technology and hundreds of applications.{' '}
          </Title>
          ...
          <StyledSectionFlex id="about" style={{ flexDirection: 'column' }}>
            ...
            <div style={{ display: 'flex', width: '100%', margin: 0 }}>
              <InternalLink to="/docs/v2/token-economics/bto">Byteco token</InternalLink>
              <InternalLink to="/whitepaper.pdf">
                English Whitepaper <span style={{ fontSize: '11px' }}>↗</span>
              </InternalLink>
              <InternalLink to="/whitepaper-cn.pdf">
                Chinese Whitepaper <span style={{ fontSize: '11px' }}>↗</span>
              </InternalLink>
              <InternalLink to="/team">
                Team <span style={{ fontSize: '11px' }}>↗</span>
              </InternalLink>
          ...
          <StyledSectionFlex id="jobs" style={{ flexDirection: 'column' }}>
            ...
            <span>
              <a href="https://jobs.lever.co/Byteco">
                {' '}
                <h3>Full list of roles available at Byteco</h3>
              </a>
            </span>
          </StyledSectionFlex>
          ...
          <StyledSectionFlex id="contact" style={{ flexDirection: 'column' }}>
            ...
            <p>
              To get in touch, please email <a href="mailto:contact@byteco.org">contact@byteco.org</a>
            </p>

            <p>
              We encourage anyone facing issues with their wallet, transaction or Byteco related question to join our
              active community discord.
            </p>

            <div style={{ display: 'flex', width: '100%', margin: 0 }}>
              <ExternalLink href={'https://discord.gg/3hrztFW8'}>
                Discord <span style={{ fontSize: '11px' }}>↗</span>
              </ExternalLink>
              <ExternalLink href={'https://twitter.com/Byteco-org'}>
                Twitter <span style={{ fontSize: '11px' }}>↗</span>
              </ExternalLink>
              <ExternalLink href={'https://www.reddit.com/r/Byteco'}>
          ...
          <StyledSectionFlex id="brand" style={{ flexDirection: 'column' }}>
            ...
            <p>
              Download the logo and other brand assets samples <a href="/Byteco_brand_assets.zip">here</a>.
            </p>
          </StyledSectionFlex>
        </span>
      </StyledAbout>
